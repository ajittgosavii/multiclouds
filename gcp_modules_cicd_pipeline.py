"""
GCP Module: CI/CD Pipeline
Cloud Build and deployment pipelines
"""
...
class GCPCICDPipelineModule:
    """GCP CI/CD Pipeline module"""
    
    @staticmethod
    def render():
        """Render GCP CI/CD Pipeline"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for CI/CD Pipeline. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Cloud Build and deployment pipelines.
