...
class GCPBackupAndDRModule:
    """GCP Backup & DR module"""
    
    @staticmethod
    def render():
        """Render GCP Backup & DR"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Backup & DR. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Backup and Disaster Recovery Service.
