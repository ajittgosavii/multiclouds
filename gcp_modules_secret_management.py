...
class GCPSecretManagementModule:
    """GCP Secret Management module"""
    
    @staticmethod
    def render():
        """Render GCP Secret Management"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Secret Management. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Secret Manager and key management.
...
def render():
    """Module entry point"""
    GCPSecretManagementModule.render()
