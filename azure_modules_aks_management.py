    ...
    def render():
        ...
        if st.session_state.get('mode') == 'Demo':
            AzureTheme.azure_info_box(
                "Demo Mode Active",
                "Displaying sample data for AKS Management. Connect your Azure account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides azure kubernetes service cluster management.
        ...
        **Features:**
        ...
        with col1:
            if st.button("🔄 Refresh Data", key="aks_management_refresh"):
                st.success("Data refreshed successfully!")
        
        with col2:
            if st.button("📊 Generate Report", key="aks_management_report"):
                st.success("Report generated successfully!")
        
        with col3:
            if st.button("⚙️ Configure", key="aks_management_config"):
