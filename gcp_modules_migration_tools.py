...
class GCPMigrationToolsModule:
    """GCP Migration Tools module"""
    
    @staticmethod
    def render():
        """Render GCP Migration Tools"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Migration Tools. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Migrate for Compute Engine.
...
def render():
    """Module entry point"""
    GCPMigrationToolsModule.render()
