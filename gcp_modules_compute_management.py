...
class GCPComputeManagementModule:
    """GCP Compute Management module"""
    
    @staticmethod
    def render():
        """Render GCP Compute Management"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Compute Management. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Manage Compute Engine instances.
...
def render():
    """Module entry point"""
    GCPComputeManagementModule.render()
