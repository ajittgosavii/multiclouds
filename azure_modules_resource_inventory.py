...
Track all Azure resources across subscriptions
"""
...
class AzureResourceInventoryModule:
    ...
    @staticmethod
    def render():
        """Render Azure Resource Inventory"""
        ...
        if st.session_state.get('mode') == 'Demo':
            AzureTheme.azure_info_box(
                "Demo Mode Active",
                "Displaying sample data for Resource Inventory. Connect your Azure account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides track all azure resources across subscriptions.
