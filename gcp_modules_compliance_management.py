"""
GCP Module: Compliance Management
...
class GCPComplianceManagementModule:
    """GCP Compliance Management module"""
    
    @staticmethod
    def render():
        """Render GCP Compliance Management"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Compliance Management. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Compliance reporting and security.
...
def render():
    """Module entry point"""
    GCPComplianceManagementModule.render()
