    ...
    def render():
        ...
        if st.session_state.get('mode') == 'Demo':
            AzureTheme.azure_info_box(
                "Demo Mode Active",
                "Displaying sample data for Machine Learning. Connect your Azure account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Azure Machine Learning and Cognitive Services.
...
def render():
    """Module entry point"""
    AzureMachineLearningModule.render()
