"""
GCP Module: Messaging & Queuing
Pub/Sub and Cloud Task
"""
...
class GCPMessagingAndQueuingModule:
    """GCP Messaging & Queuing module"""
    
    @staticmethod
    def render():
        """Render GCP Messaging & Queuing"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Messaging & Queuing. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Pub/Sub and Cloud Task.
...
def render():
    """Module entry point"""
    GCPMessagingAndQueuingModule.render()
