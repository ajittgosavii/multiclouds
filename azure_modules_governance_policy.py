"""
Azure Module: Governance & Policy
    ...
    def render():
        ...
        if st.session_state.get('mode') == 'Demo':
            AzureTheme.azure_info_box(
                "Demo Mode Active",
                "Displaying sample data for Governance & Policy. Connect your Azure account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Azure Policy and Management Groups.
...
def render():
    """Module entry point"""
    AzureGovernanceAndPolicyModule.render()
