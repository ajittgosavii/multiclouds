"""
GCP Module: AI Assistant
AI-powered GCP recommendations
"""
...
class GCPAIAssistantModule:
    """GCP AI Assistant module"""
    
    @staticmethod
    def render():
        """Render GCP AI Assistant"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for AI Assistant. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides AI-powered GCP recommendations.
