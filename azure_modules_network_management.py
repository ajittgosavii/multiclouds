...
Manage Virtual Networks (VNets) and networking
"""
...
class AzureNetworkManagementModule:
    ...
    @staticmethod
    def render():
        """Render Azure Network Management"""
        ...
        if st.session_state.get('mode') == 'Demo':
            AzureTheme.azure_info_box(
                "Demo Mode Active",
                "Displaying sample data for Network Management. Connect your Azure account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides manage virtual networks (vnets) and networking.
