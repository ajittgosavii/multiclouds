"""
GCP Module: Infrastructure as Code
...
class GCPInfrastructureasCodeModule:
    """GCP Infrastructure as Code module"""
    
    @staticmethod
    def render():
        """Render GCP Infrastructure as Code"""
        ...
        if st.session_state.get('mode') == 'Demo':
            GCPTheme.gcp_info_box(
                "Demo Mode Active",
                "Displaying sample data for Infrastructure as Code. Connect your GCP account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides Deployment Manager and Terraform.
...
def render():
    """Module entry point"""
    GCPInfrastructureasCodeModule.render()
