"""
Azure Module: Compute Management
...
class AzureComputeManagementModule:
    """Azure Compute Management module"""
    
    @staticmethod
    def render():
        """Render Azure Compute Management"""
        ...
        if st.session_state.get('mode') == 'Demo':
            AzureTheme.azure_info_box(
                "Demo Mode Active",
                "Displaying sample data for Compute Management. Connect your Azure account to see real data.",
                "info"
            )
        ...
        st.write("""
        This module provides manage virtual machines and compute resources.
        ...
        **Features:**
        ...
        with col1:
            if st.button("🔄 Refresh Data", key="compute_management_refresh"):
                st.success("Data refreshed successfully!")
        
        with col2:
            if st.button("📊 Generate Report", key="compute_management_report"):
                st.success("Report generated successfully!")
        
        with col3:
            if st.button("⚙️ Configure", key="compute_management_config"):
                st.info("Configuration options coming soon!")

def render():
    """Module entry point"""
    AzureComputeManagementModule.render()
